          ...
          <div class="col-md-6">
            <div class="row">
              <div class="col-sm-6 smallpad">
                <button type="button" class="btn btn-primary btn-block" id="run" onClick={() => run(1000)}>Create 1,000 rows</button>
              </div>
              <div class="col-sm-6 smallpad">
                <button type="button" class="btn btn-primary btn-block" id="runlots" onClick={() => run(10000)}>Create 10,000 rows</button>
              </div>
              <div class="col-sm-6 smallpad">
                <button type="button" class="btn btn-primary btn-block" id="add" onClick={() => add(1000)}>Append 1,000 rows</button>
              </div>
              <div class="col-sm-6 smallpad">
              ...
              <HBtn id="run-10" onClick={() => run(10)}>Create 10</HBtn>
              <HBtn id="run-100" onClick={() => run(100)}>Create 100</HBtn>
              <HBtn id="run-1k" onClick={() => run(1000)}>Create 1k</HBtn>
              <HBtn id="run-10k" onClick={() => run(10000)}>Create 10k</HBtn>
              <HBtn id="add-10" onClick={() => add(10)}>Append 10</HBtn>
              <HBtn id="add-100" onClick={() => add(100)}>Append 100</HBtn>
              <HBtn id="add-1k" onClick={() => add(1000)}>Append 1k</HBtn>
              <HBtn id="add-10k" onClick={() => add(10000)}>Append 10,000</HBtn>
            </div>
          </div>
        </div>
      </div>
    ...
    <For each={data()}>
      {(row: Row) => (
        <tr class={row.id === selectedId() ? 'danger' : ''}>
          ...
          <td class="col-md-4">
            <a href="#" class="lbl" aria-label="Select row">{row.label()}</a>
          </td>
          <td class="col-md-1">
